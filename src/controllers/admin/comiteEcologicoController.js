...
exports.crear = async (req, res) => {
    ...
    await pool.query(
        'INSERT INTO comite_ecologico (nombre, rol, foto_url, orden, nivel) VALUES ($1, $2, $3, $4, $5)',
...
exports.editar = async (req, res) => {
    ...
    await pool.query(
        'UPDATE comite_ecologico SET nombre = $1, rol = $2, foto_url = $3, orden = $4, nivel = $5 WHERE id = $6',
